 ...
 *
//to get the SimpleFTPServer to work with the SD_MMC library you have to modify the actual arduino library which sucks
//In Windows its here: C:\Users\<you>\Documents\Arduino\libraries\SimpleFTPServer\FtpServerKey.h
//you change DEFAULT_STORAGE_TYPE_ESP32 from STORAGE_SPIFFS to STORAGE_SD_MMC
//#define DEFAULT_STORAGE_TYPE_ESP32    STORAGE_SD_MMC    //was STORAGE_SPIFFS
// or we can define this file locally.
 */
...
// esp32 configuration
	...
	//#define DEFAULT_STORAGE_TYPE_ESP32 					STORAGE_FFAT	//Original value
	#define DEFAULT_STORAGE_TYPE_ESP32    STORAGE_SD_MMC				//Force us to use SD_MMC
	/**
...
#if DEFAULT_STORAGE_TYPE_ESP32 == STORAGE_SD_MMC
    #pragma message "✓ Using SD_MMC storage. IN LOCALLY DEFINED FtpServerKey.h"
#else
    #pragma message "✗ Still using default storage - override failed. IN LOCALLY DEFINED FtpServerKey.h"
#endif
